...
namespace RFVault.Patches
{
    ...
    {
        private static bool Prefix(PlayerInventory __instance, byte page_0, byte x_0, byte y_0, byte rot_0, byte page_1,
            byte x_1, byte y_1, byte rot_1)
        {
            try
            {
            ...
            {
                Logger.LogError($"[{Plugin.Inst.Name}] [ERROR] PlayerEvent ReceiveSwapItem: " + e.Message);
